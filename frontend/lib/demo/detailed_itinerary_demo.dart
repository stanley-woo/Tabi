...
import 'package:frontend/services/itinerary_service.dart';

class DetailedItineraryDemo extends StatefulWidget {
  final int id;
  const DetailedItineraryDemo({Key? key, required this.id}) : super(key: key);
...
class _DetailedItineraryDemoState extends State<DetailedItineraryDemo> {
  ...
  Widget build(BuildContext context) {
    FutureBuilder<Itinerary> con = FutureBuilder<Itinerary>(
      future: _futureItin,
      builder: (ctx, snap) {
